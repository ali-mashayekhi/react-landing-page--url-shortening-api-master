    ...
    <section className="bg-gray-transparent-custom pb-[4.8125rem] pt-11 sm:mx-auto sm:py-[3.75rem] ">
      <div className="mx-auto max-w-[72.375rem] px-6">
        <div className="mb-[5.625rem] px-4 sm:mx-auto  sm:mb-24 sm:w-[34.375rem]">
          <h2 className="mb-7 text-center text-[1.75rem]  font-bold tracking-tight text-very-dark-violet-custom sm:mb-2 sm:text-[clamp(1.75rem,3.8vw,2.4375rem)] lg:text-[2.4375rem]">
            Advanced Statistics
          </h2>
          <p className="text-center text-base leading-7 text-grayish-violet-custom sm:text-[clamp(1rem,1.75vw,1.125rem)] lg:text-lg">
        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-[9] sm:gap-7 sm:gap-y-0">
          ...
          <div className="mb-[5.625rem] flex flex-col items-center rounded-md bg-white px-6 pb-10 shadow-sm sm:row-span-7 sm:row-start-1 sm:mb-0 sm:items-start sm:px-7">
          ...
          <div className=" mb-[5.625rem] flex flex-col items-center rounded-md bg-white px-6 pb-10 shadow-sm sm:row-span-7 sm:row-start-2 sm:mb-0 sm:items-start sm:px-7">
            <div className="flex h-[5.5rem] w-[5.5rem] -translate-y-1/2 items-center justify-center rounded-full bg-dark-violet-custom">
          ...
          <div className="flex flex-col items-center rounded-md bg-white px-6 pb-10 shadow-sm sm:row-span-7 sm:row-start-3 sm:items-start sm:px-7">
            <div className="flex h-[5.5rem] w-[5.5rem] -translate-y-1/2 items-center justify-center rounded-full bg-dark-violet-custom">
